...
//
//        private ParkingServiceManager parkingServiceManager = new ParkingServiceManager();
//
//    @Test
...
//        parkingServiceManager.findAll(car.getId()).forEach(cars::add);
...
//        parkingServiceManager.findAll(car1.getId()).forEach(cars1::remove);
...
//        Car car2 = new Car("453", "206", "Peugeot", Color.BLACK);
//
//        parkingServiceManager.findAll(car2.getId());
//
//        List<Car> cars2 = new ArrayList<>();
//        parkingServiceManager.findAll(car2.getId()).forEach(cars2::add);
//        assertEquals(cars2.size(), 0);
//        assertEquals(cars2.get(0).getColor(), Color.BLACK);
//        assertEquals(cars2.get(0).getIDname(), "453");
//        assertEquals(cars2.get(0).getManufacture(), "Peugeot");
//        assertEquals(cars2.get(0).getModel(), "206");
//    }
//}